...
function OrderDrawer({ order, onClose, onStatus, onDelete }) {
  ...
  const rows = [
    ...
    ["Pages", `${order.pages} (+${order.extra_pages} supp.)`], ["Design", order.design_title || "Non renseigné"],
