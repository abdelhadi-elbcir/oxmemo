...
export default function Footer() {
  return (
    <footer id="footer" style={{ background: COLORS.navyDeep, color: "#a9c0da", padding: "64px 0 28px" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          <div>
            <div className="font-display flex items-center gap-2.5" style={{ fontWeight: 800, fontSize: 20, color: COLORS.white }}>
              <LogoMark />
              OXmemo
            </div>
